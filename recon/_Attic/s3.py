...
def list_objects(bucket,prefix,limit=None,delimiter=None):
    """Returns a generator that lists objects in a bucket. 
    The generator returns dictionaries, where elements include: 'LastModified', 'ETag', 'StorageClass', 'Key', 'Size'.
    e.g. {'LastModified': '2019-01-02T16:44:26.000Z', 'ETag': '"47a53849612d84bc3cae3ca1d0c580fd-83"', 'StorageClass': 'STANDARD', 'Key': 'cleanup/prefix1/prefix2/model_04001942600.lp', 'Size': 692937044}
    """
    next_token = None
    total = 0
    while True:
